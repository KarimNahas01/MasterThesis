...
RECEIVER_IP = '192.168.2.218' #Raspberry PI
RECEIVER_PORT = 30005
...
def main():
    ...
    while True:
        ...
        if not USING_REALSENSE_CAMERA: continue
        depth_colormap, depth_image, color_image = display_image(display_rgb=True, display_depth=True, display_infrared=False)
