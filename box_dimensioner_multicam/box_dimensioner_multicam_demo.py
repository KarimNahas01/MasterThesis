...
def run_demo():
	...
	try:
		...
		device_manager.load_settings_json("C:/Users/karim/OneDrive - Chalmers/University/Complex Adaptive Systems MSc/Master thesis/Example code/box_dimensioner_multicam/HighResHighAccuracyPreset.json")
